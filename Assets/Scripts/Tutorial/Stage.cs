...
public abstract class Stage : MonoBehaviour
{
    ...
    public BuildingType CurrentlyLerping { get => currentlyLerping; }
    public TileData LastTileChecked { get => lastTileChecked; }
    public List<Locatable> LerpTargets { get => lerpTargets; }
    ...
    private void GoToStep(int nextStep)
    {
        MouseController.Instance.ReportTutorialClick = false;
        tileClicked = false;
        currentlyLerping = ButtonType.None;
